...
if(mouseColor==endColor) {
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("386010__dudeawesome__haunting-suspenseful-fearful-ambience-long (1).flac"));
